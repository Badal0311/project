    ...
    function weather_report(){
        ...
        .then(function(data1) {
            ...
            .then(function(data3) {
                ...
                document.getElementById('wind_humid4').innerHTML = "<center><b>Wind Speed :</b> &nbsp&nbsp&nbsp&nbsp&nbsp"+response['daily'][1]['wind_speed']+" kmph &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"+"<b>Humidity :</b> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"+response['daily'][1]['humidity']+"%</center>";
                ...
                document.getElementById('wind_humid5').innerHTML = "<center><b>Wind Speed :</b> &nbsp&nbsp&nbsp&nbsp&nbsp"+response['daily'][2]['wind_speed']+" kmph &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"+"<b>Humidity :</b> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"+response['daily'][2]['humidity']+"%</center>";
                ...
                .then(function(data4) {
                  ...
                  document.getElementById('temp_feel1').innerHTML = "<center><b>Temp :</b> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"+response2['current']['temp']+"°C &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"+"<b>Feels Like :</b> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"+response2['current']['feels_like']+"°C</center>";
                ...
                .then(function(data5) {
                  ...
                  document.getElementById('temp_feel2').innerHTML = "<center><b>Temp :</b> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"+response3['current']['temp']+"°C &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"+"<b>Feels Like :</b> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"+response3['current']['feels_like']+"°C</center>";
